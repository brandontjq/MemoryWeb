...
<html lang="en">
    ...
    <body onLoad="start()">
        ...
        <div class="container">
            ...
            <!-- Page Heading -->
            <h1 class="my-4"><bold>New Event</bold></h1>
            <br></br><br></br>
            <!-- Project One -->
            <div class="container">
                    ...
                    <div class="col-md-7">
                        <div class="span7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="eventname" class="form-control input-lg" id="eventname" placeholder="Enter event name">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="description">Description</label>
                                <div class="col-sm-8">
                                    <input type="text" name="description" class="form-control input-lg" id="description" placeholder="Enter descripton">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="location">Location</label>
                                <div class="col-sm-8"> 
                                    <input id="location" type="text" name="location" class="form-control input-lg" placeholder="Enter location">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-10">
